...
- O teorema da aproximação universal (Hornik et al.) fala que um MLP com uma camada com uma função de ativação que achata as entradas, pode aproximar qualquer função desde que ela tenha um número suficiente de **'hidden units'**.

- Na prática isso não funciona muito bem porque o número de **'hidden units'** pode ter de ser muito grande - então esbarramos na quantidade de dados disponível.
