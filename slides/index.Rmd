...
$$w_{(i+1)} = w_{(i)} - \alpha \frac{\partial L}{\partial w} = w_{(i)} - \alpha \frac{1}{n}\sum_{i=1}^{n} (-2 \times x_i)(y_i - w \times x_i -b)$$

$$b_{(i+1)} = b_{(i)} - \alpha \frac{\partial L}{\partial b} = b_{(i)} - \alpha \frac{1}{n} \sum_{i=1}^{n} (-2)(y_i - w \times x_i -b)$$
...
$$w_{(i+1)} = w_{(i)} - \alpha \times \left( 2(y_i - \hat{y}) \times x_i \right)$$

$$b_{(i+1)} = b_{(i)} - \alpha \times \left( 2(y_i - \hat{y}) \times 1 \right)$$
